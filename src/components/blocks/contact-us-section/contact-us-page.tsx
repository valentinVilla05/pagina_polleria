    ...
    >
      ...
      <div className='relative z-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid items-center gap-12 lg:grid-cols-2 lg:gap-16'>
          ...
          <div>
            <h3 className='mb-3 text-3xl font-bold tracking-tight' style={{ color: '#7a1e1e' }}>
              Estamos para atenderte
            </h3>
            <p className='mb-8 text-lg leading-relaxed font-semibold' style={{ color: '#7a1e1e', opacity: 0.85 }}>
